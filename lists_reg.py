"""
instead of writing the coding regions into a file.. make a list of coding and  non coding regions.Code_dict :
dictionary of coding regions Non_Code_dict: dictionary of non coding regions key: starting index of region value:
region
"""
...
# species type recieved
s_codon = Start_Codon[int(species_type)]
# start codon found
coding_fd = open("coding_reg.txt", 'w')
noncoding_fd = open("non_coding_reg.txt", 'w')
